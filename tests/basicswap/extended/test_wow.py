...
WOW_WALLET_RPC = os.getenv('WOW_WALLET', 'monero-wallet-rpc' + cfg.bin_suffix)
...
class Test(BaseTest):
    ...
    def coins_loop(cls):
        ...
        if cls.wow_addr is not None:
            callrpc_xmr(WOW_BASE_RPC_PORT + 1, 'generateblocks', {'wallet_address': cls.wow_addr, 'amount_of_blocks': 1})
    ...
    def prepareExtraDataDir(cls, i):
        for i in range(NUM_NODES):
            ...
            waitForWOWNode(i, cls.wow_wallet_auth[i])
