...
"""
Adapted from version https://github.com/dourvaris/nano-python/blob/master/src/nano/ed25519_blake2.py
"""
...
def H(m):
    return bytearray(hashlib.blake2b(m).digest())
...
def publickey_unsafe(sk, hash_func=H):
    ...
    """
    #print("basicswap/xno_crypto_ed25519.py publickey_unsafe sk", repr(sk))
    h = hash_func(sk)
