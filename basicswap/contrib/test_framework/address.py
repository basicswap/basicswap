...
class TestFrameworkScript(unittest.TestCase):
    def test_base58encodedecode(self):
        ...
        check_base58(
            b"A\xc1\xea\xf1\x11\x80%Y\xba\xd6\x1b`\xd6+\x1f\x89|c\x92\x8a", 111
        )
        check_base58(
            b"\0A\xc1\xea\xf1\x11\x80%Y\xba\xd6\x1b`\xd6+\x1f\x89|c\x92\x8a", 111
        )
        check_base58(
            b"\0\0A\xc1\xea\xf1\x11\x80%Y\xba\xd6\x1b`\xd6+\x1f\x89|c\x92\x8a", 111
        )
        check_base58(
            b"\0\0\0A\xc1\xea\xf1\x11\x80%Y\xba\xd6\x1b`\xd6+\x1f\x89|c\x92\x8a", 111
        )
